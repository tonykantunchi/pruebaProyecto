...
const STRIPE_PUBLIC_KEY = process.env.REACT_APP_STRIPE_PK || "pk_live_51TTsj9Pk1ZHAxxG3CBcJRjMGIf9n8INRuMsGi5PpUhDsVKikVs4HN092MuQhDcLvqpN5uGpokFxThFMsGCDGjHkX00sKrgCM4q";
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errData.detail || "Error al crear el pago");
      }
      ...
      <div className="max-w-lg mx-auto px-4 sm:px-6 py-12 relative z-10">
        ...
        {step === "form" && (
          <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-[#e8cdbb]/60 p-8">
            {/* ... (mantengo el resto igual, solo muestro cambios importantes) */}
            ...
            {/* Selector de moneda, montos y custom amount (se mantiene igual) */}
            <div className="mb-6">
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-[#e8cdbb]/60 p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex gap-3">
                <button type="button" onClick={() => { setStep("form"); cardMounted.current = false; }}
        ...
        {step === "error" && (
          <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-red-200/60 p-10 text-center">
            ...
            <button onClick={() => setStep("payment")} className="px-8 py-3 rounded-full bg-[#C0574A] text-white font-bold">
              Intentar de nuevo
            </button>
          </div>
        )}
